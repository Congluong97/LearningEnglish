...
<head>
  ...
  <link rel="icon" type="image/png" href="{{asset('')}}public/adminlte/dist/img/english.png">
</head>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('')}}public/adminlte/dist/img/user_image.png" class="user-image" alt="User Image">
